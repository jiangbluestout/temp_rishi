...
!function() {
/*!*****************************************************!*\
  !*** ./src/scripts/components/skio-prepaid-gift.js ***!
  \*****************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   SkioPrepaidGift: function() { return /* binding */ SkioPrepaidGift; }
/* harmony export */ });
/* harmony import */ var lit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lit */ "./node_modules/lit/index.js");

class SkioPrepaidGift extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
  static properties = {
    key: {
      type: String
    },
  ...
  static styles = (0,lit__WEBPACK_IMPORTED_MODULE_0__.css)`
    ...
    .skio-prepaid-input label {
      font-family: Protrakt,Open Sans,arial,sans-serif;
      font-size: 12px;
      font-weight: 700;
      letter-spacing: .8px;
      padding: 0 5px;
    ...
    .skio-prepaid-input textarea, .skio-prepaid-input input {
    ...
    .skio-prepaid-input textarea:focus, .skio-prepaid-input input:focus {
      border-color: #283645;
    }

    .skio-gift-prepaid-content.open {
      max-height: 300px;
      opacity: 1;
    }
    ...
    .skio-prepaid-switch input {
      opacity: 0;
      width: 0;
      height: 0;
    }

    .skio-prepaid-switch input:checked + .skio-prepaid-slider {
      background-color: #283645;
    }

    .skio-prepaid-switch input:focus + .skio-prepaid-slider {
      box-shadow: 0 0 1px #283645;
    }

    .skio-prepaid-switch input:checked + .skio-prepaid-slider:before {
  ...
  constructor() {
    ...
    this.email = '';
    this.message = '';
    this.planPicker = null;
  }
  connectedCallback() {
    var _this$planPicker$sele;
    super.connectedCallback();
    this.planPicker = document.querySelector(`skio-plan-picker[key="${this.key}"]`);
    if (!this.planPicker) return;
    this.isPrepaidSelected = ((_this$planPicker$sele = this.planPicker.selectedSellingPlanGroup) === null || _this$planPicker$sele === void 0 ? void 0 : _this$planPicker$sele.name) === 'Prepaid';
    this.planPicker.addEventListener('skio::update-selling-plan', e => {
      this.isPrepaidSelected = e.detail.isPrepaid;
    });
  }
  updated = changed => {
    this.updateForm();
  ...
  render() {
    if (!this.isPrepaidSelected) return;
    return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)`
       <div class="skio-gift-prepaid">
        <div class="skio-prepaid-topline">
          <label class="skio-prepaid-switch">
            <input type="checkbox" name="is-prepaid-gift" .checked="${this.isPrepaidGift}" @change="${e => this.isPrepaidGift = !this.isPrepaidGift}">
            <span class="skio-prepaid-slider round"></span>
          </label>

          Gift this subscription
        </div>
        
        <div class="skio-gift-prepaid-content ${this.isPrepaidGift ? 'open' : ''}">
          <div class="skio-prepaid-input">
            <label for="prepaidGiftEmail">Gift Recipient Email</label>
            <input type="email" placeholder="recipient@email.com" @input="${e => this.email = e.target.value}"/>
          </div>

          <div class="skio-prepaid-input">
            <label for="prepaidGiftMessage">Message (optional)</label>
            <textarea placeholder="Enter your gift message" @input="${e => this.message = e.target.value}"></textarea>
          </div>
        </div>
      </div>
    `;
